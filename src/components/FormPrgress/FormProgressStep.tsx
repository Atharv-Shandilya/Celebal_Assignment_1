export default ({
  ...
  return (
    <div className="w-fit flex flex-col items-center mr-[20px]  sm:mr-[112px] last-of-type:mr-0 relative ">
      <p
        className={` relative bg-[#D9D9D9] transition-colors rounded-full w-[20px] h-[20px] flex items-center justify-center text-xs mb-2 ${
      ...
      {isNext && (
        <div
          className={` w-[100px] h-[2px] absolute top-[7px] left-[30px] rounded-full hidden sm:block transition-colors ${
